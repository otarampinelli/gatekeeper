...
// How much of the diff is content that exists on both sides — moves and reindents rather
// than new behavior. Whitespace is stripped per line so a reindent counts as a move.
// Note ' \t' and not \s: stripping all whitespace would remove the newlines too.
